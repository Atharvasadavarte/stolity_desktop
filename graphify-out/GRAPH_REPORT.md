# Graph Report - stolity_desktop  (2026-05-13)

## Corpus Check
- 68 files · ~24,891 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 405 nodes · 567 edges · 47 communities (35 shown, 12 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 21 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b2d20024`
...
- `webview_screen.dart` --defines--> `dispose`  [EXTRACTED]
...
Cohesion: 0.12
Nodes (7): BuddyFileProviderDomainSupport, BuddyFileProviderItem, NSFileProviderItem, FileProviderItem, StolityFileItem, StolityFileProviderDomainSupport, StolityFileProviderItem
...
Cohesion: 0.22
Nodes (3): NSFileProviderEnumerator, RootEnumerator, WorkingSetEnumerator
...
## Knowledge Gaps
- **72 isolated node(s):** `missingToken`, `invalidStartResponse`, `main`, `package:flutter_test/flutter_test.dart`, `package:stolity_desktop/main.dart` (+67 more)
...
- **Why does `main()` connect `Community 6` to `Community 14`?**
  _High betweenness centrality (0.082) - this node is a cross-community bridge._
- **Why does `my_application_activate()` connect `Community 6` to `Community 11`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `fl_register_plugins()` connect `Community 11` to `Community 6`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **What connects `missingToken`, `invalidStartResponse`, `main` to the rest of the system?**
