# Graph Report - stolity_desktop  (2026-05-12)

## Corpus Check
- 65 files · ~21,922 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 359 nodes · 483 edges · 41 communities (33 shown, 8 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 21 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8f28c5be`
...
3. `AppDelegate` - 14 edges
4. `SequencedContents` - 13 edges
5. `FileProviderExtension` - 11 edges
6. `StolityFileProviderExtension` - 11 edges
7. `BuddyFileProviderExtension` - 11 edges
8. `StolityWorkingSetEnumerator` - 10 edges
9. `BuddyWorkingSetEnumerator` - 9 edges
10. `WorkingSetEnumerator` - 8 edges
...
- `webview_screen.dart` --defines--> `_openWindowsPopup`  [EXTRACTED]
...
Cohesion: 0.07
Nodes (16): BuddyFileProviderDomainSupport, BuddyFileProviderItem, PodsDummy_file_picker, PodsDummy_flutter_inappwebview_macos, PodsDummy_flutter_secure_storage_darwin, NSFileProviderItem, NSObject, PodsDummy_OrderedSet (+8 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (32): auth_token_service.dart, dart:collection, dart:developer, package:flutter/foundation.dart, _armPopupFallback, _attemptAutoLogin, _authLog, build (+24 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (33): dart:async, dart:ui, services/download_service.dart, services/file_picker_service.dart, services/window_service.dart, _buildNavigationPill, ColoredBox, Dialog (+25 more)
...
Cohesion: 0.13
Nodes (5): NSFileProviderEnumerator, RootEnumerator, StolityRootEnumerator, StolityWorkingSetEnumerator, WorkingSetEnumerator
...
Cohesion: 0.12
Nodes (3): NSFileProviderReplicatedExtension, FileProviderExtension, StolityFileProviderExtension
...
Cohesion: 0.13
Nodes (13): dart:convert, dart:io, dart:typed_data, package:flutter_secure_storage/flutter_secure_storage.dart, AuthTokenService, isTokenValid, Directory, _downloadsDirectory (+5 more)
...
## Knowledge Gaps
- **70 isolated node(s):** `main`, `package:flutter_test/flutter_test.dart`, `package:stolity_desktop/main.dart`, `package:stolity_desktop/webview_screen.dart`, `Intercept NOTIFY_DEBUGGER_ABOUT_RX_PAGES and touch the pages.` (+65 more)
...
- **Why does `main()` connect `Community 7` to `Community 12`?**
  _High betweenness centrality (0.104) - this node is a cross-community bridge._
- **Why does `my_application_activate()` connect `Community 7` to `Community 10`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `fl_register_plugins()` connect `Community 10` to `Community 7`?**
  _High betweenness centrality (0.083) - this node is a cross-community bridge._
- **What connects `main`, `package:flutter_test/flutter_test.dart`, `package:stolity_desktop/main.dart` to the rest of the system?**
