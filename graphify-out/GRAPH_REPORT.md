...
## Corpus Check
- 65 files · ~21,822 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 357 nodes · 478 edges · 44 communities (33 shown, 11 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 20 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `574e65c6`
...
- `webview_screen.dart` --defines--> `initState`  [EXTRACTED]
...
Cohesion: 0.14
Nodes (6): BuddyFileProviderDomainSupport, BuddyFileProviderItem, NSFileProviderItem, FileProviderItem, StolityFileProviderDomainSupport, StolityFileProviderItem

### Community 11 - "Community 11"
Cohesion: 0.19
Nodes (3): BuddyRootEnumerator, BuddyWorkingSetEnumerator, NSFileProviderEnumerator
...
- **Why does `main()` connect `Community 5` to `Community 12`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `my_application_activate()` connect `Community 5` to `Community 8`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `fl_register_plugins()` connect `Community 8` to `Community 5`?**
